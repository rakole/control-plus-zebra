...
import type {
  EntityWriteBatch,
  EntityWriter,
  EntityWriterLifecycleMarker
} from "../../../src/main/core/store/entity-writer.js";
import {
  decodeOpaqueCursor,
  encodeOpaqueCursor,
...
import type { Project, Session, SessionEvent } from "../../../src/main/core/model/entities.js";
...
export interface WorkbenchEntityStoreContractFixture {
  store: WorkbenchEntityStore & EntityWriter;
  close?(): Promise<void> | void;
}

export function runWorkbenchEntityStoreContractSuite(
  name: string,
  createFixture: () => WorkbenchEntityStoreContractFixture
): void {
  describe(name, () => {
    ...
    it("rejects invalid cursors with a typed sanitized error", async () => {
      try {
...
export class FakeWorkbenchEntityStore implements WorkbenchEntityStore, EntityWriter {
